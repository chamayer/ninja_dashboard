-- =============================================================================
-- 011_current_devices.sql
-- Track whether a device is still returned by Ninja's current inventory.
-- Missing devices are retained for history but excluded from current dashboards.
-- =============================================================================

ALTER TABLE ninja_core.devices
...
CREATE INDEX IF NOT EXISTS devices_current_idx
    ON ninja_core.devices (is_current);
CREATE INDEX IF NOT EXISTS devices_current_org_class_idx
    ON ninja_core.devices (is_current, organization_id, node_class);
