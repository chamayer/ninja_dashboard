"""Expose source archive state through the CMDB inventory evidence view."""
...
VIEW_SQL = """
CREATE OR REPLACE VIEW operations.v_cmdb_inventory_evidence_current
...
class Migration(migrations.Migration):
    dependencies: ClassVar = [
        ("operations", "0147_cmdb_inventory_evidence_read_model"),
    ]

    operations: ClassVar = [
        migrations.RunSQL(VIEW_SQL, REVERSE_SQL),
