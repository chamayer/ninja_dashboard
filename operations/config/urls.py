...
urlpatterns = [
    ...
    path(
        "merge-candidates/<uuid:candidate_id>/review/",
        merge_candidate_group_review,
        name="merge_candidate_group_review",
    ),
    ...
    path("findings/<uuid:finding_id>/review/", finding_review, name="finding_review"),
    ...
    path("admin/jobs/status/", admin_job_status, name="admin_job_status"),
    path("admin/jobs/status/<uuid:run_id>/cancel/", admin_job_cancel, name="admin_job_cancel"),
    path("admin/jobs/status/<uuid:run_id>/retry/", admin_job_retry, name="admin_job_retry"),
    path("admin/jobs/status/history/<str:job_key>/retry/", admin_job_history_retry, name="admin_job_history_retry"),
    ...
    path("findings/<uuid:finding_id>/refresh/", finding_refresh, name="finding_refresh"),
    path("findings/<uuid:finding_id>/reviewed-distinct/", finding_reviewed_distinct, name="finding_reviewed_distinct"),
    ...
    path("software/category/decide", software_category_decide, name="software_category_decide"),
    path(
