...
urlpatterns = [
    ...
    path("orgs/<slug:org_slug>/devices/<uuid:device_id>/exemption/add/", device_exemption_add, name="device_exemption_add"),
    path("orgs/<slug:org_slug>/devices/<uuid:device_id>/exemption/clear/", device_exemption_clear, name="device_exemption_clear"),
    path("orgs/<slug:org_slug>/devices/<uuid:device_id>/merge/<uuid:target_id>/", device_merge, name="device_merge"),
